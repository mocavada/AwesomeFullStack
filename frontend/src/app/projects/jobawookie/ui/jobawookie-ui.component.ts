...
import { Jobpost } from './../pojo/jobpost';
...
@Component({
  selector: 'app-jobawookie-ui',
  templateUrl: './jobawookie-ui.component.html',
  styleUrls: ['./jobawookie-ui.component.css']
})
export class JobawookieUiComponent implements OnInit {
