...
//    }
    ...
    public @ResponseBody
    void deleteJob(@PathVariable("id") Long id) {
    ...
    @RequestMapping(
            ...
            value = "/company")
    @ResponseStatus(HttpStatus.CREATED)
    public @ResponseBody List<JobCompany> createCompany(@RequestBody JobCompany company) {
        JobCompany jobCompanySaved = this.jobBankService.createCompany(company);
